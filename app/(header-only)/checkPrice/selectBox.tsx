...
export default function SelectBox({nameMenu, type, value, setValue, isOpen, setIsOpen, list, handleChangeSelect, handleChangeOpen} : SelectBoxProps) {
          ...
          >
            {   
                list.map((item :any, index: any) => (    
                    <SelectItem type={type} key={index} data={item[type]} handleSelect={handleSelect} />
                ))
            }
          </motion.ul>
        </motion.nav>
...
function SelectItem({data, type, handleSelect} : SelectItemProps) {
