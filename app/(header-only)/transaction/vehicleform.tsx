...
export default function VehicleForm({ vehicleform, handleToSetVehicleForm, filePreview, setFilePreview, setState }: VehicleFormProps) {
    ...
    async function checkErrorForm() {
        const requiredFields = [
            "registrationDate", "registrationNumber", "province", "vehicleType", 
            ...
            <div className="container h-auto w-full flex  border-primaryText border-[1px] rounded-2xl bg-primaryBackground px-16 py-24">
                <div className="w-full h-full flex flex-col gap-20">
                    ...
                    <div className="flex flex-col gap-12 justify-center">
                        {/* row 1 */}
                        <Form content1="วันจดทะเบียน" content2="เลขทะเบียน" tag1="registrationDate" tag2="registrationNumber" handleToSetVehicleForm={handleToSetVehicleForm} vehicleform={vehicleform} errorFields={errorFields} setErrorFields={setErrorFields} />
