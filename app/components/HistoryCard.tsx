...
function HistoryCard(props:any) {
    ...
    const routeToHistoryDetails = ()=>{
        router.push("/history/details")
    }
    return (
        <div className="w-full md:p-5 border border-primaryText bg-primaryBackground rounded-3xl mx-6 md:mx-24 container py-5 cursor-pointer hover:border-4 hover:shadow-2xl hover:scale-105 duration-300 ease-in-out" onClick={routeToHistoryDetails}>
